...
<section id="report_list">
	<h4>全部で{{ $count }}件の記事があります。</h4>
	<p>
		<a href="{{ route('report.report_list') }}?offset={{ $offset }}&order=desc">新着降順</a>｜<a href="{{ route('report.report_list') }}?offset={{ $offset }}&order=asc">新着昇順</a>
	</p>
	@include('post_table')
	<p>
